...
Two middleware functions by default which are are located in the `eining.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `eining.handler` namespace to manage the enabled middleware.
